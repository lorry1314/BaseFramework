...
public class FileUtil {
    ...
    public static File getOutputMediaFile(){
        ...
        if(!state.equals("mounted")){
            //TODO: toast "please use SDcard"
            return null;
        }
        Log.d("mountstate", state);
        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),"BottleRunCustomCamera");
        ...
        File picFile = new File(mediaStorageDir.getPath()+File.separator+"IMG_TEMP.jpg");
     ...
     * @throws Exception
     */
    private static long getFilesSize(File f) throws Exception {
        long size = 0;
