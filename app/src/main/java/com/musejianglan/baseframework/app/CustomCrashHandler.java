...
//    	App.mApp.startActivity(new Intent(App.mApp,MainMenuActivity.class));
    ...
    /** 
     * 保存获取的 软件信息，设备信息和出错信息保存在SDcard中 通过 file explorer 查看 mnt/shell/emulated/crash 小写
     * @param context 
     * @param ex 
     * @return 
     */  
    ...
    private String savaInfoToSD(Context context, Throwable ex){
        ...
        if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
            File dir = new File(SDCARD_ROOT + File.separator + "gbb"+ File.separator+"crash" + File.separator);
            if(! dir.exists()){  
                dir.mkdir();  
            }
            else
